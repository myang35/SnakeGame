...
public class Game extends Canvas implements Runnable {
    ...
    private String highScore; // [name, score]
    ...
    public Game() {
        FileChooser.setMediaPath("C:\\Users\\marvi\\Documents\\NetBeansProjects\\SnakeGame\\src\\SnakeGame\\");
        File file = new File(FileChooser.getMediaPath("HighScores.txt"));
        
        try {
            Scanner scanner = new Scanner(file);
            String[] highScoreData = scanner.nextLine().split(",");
            highScoreName = highScoreData[0];
            highScore = highScoreData[1];
    ...
    private void render() {
        ...
        // show score
        int points = head.getBodyNum();
        g.setFont(new Font("ARIEL", 0, 20));
        g.setColor(Color.WHITE);
        g.drawString("pts: " + points, 10, 25);
